  ...
  return new Promise(function(resolve, reject) {
    ...
    openPromise.then(function() {
      ...
      return new Promise(function(innerResolve, innerReject) {
        ...
        var request = store.put({ url: url, ...storableData });
        
        request.onsuccess = function() { innerResolve(); };
        request.onerror = function(event) { innerReject(event.target.error); };
      });
...
IDBCache.prototype._storableToResponse = function(data) {
  return Promise.resolve(new Response(data.body, {
    status: data.status,
